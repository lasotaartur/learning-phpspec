...
/**
 * Kata based on https://laracasts.com/series/code-katas-in-php/episodes/1
 */
class PrimeFactorySpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(PrimeFactory::class);
    }
